...
- `OLLAMA_BASE_URL` alcanzable desde Supabase (túnel en prod)
...
Arquitectura: `docs/cms-commercial-architecture.md` § OCR. Plan implementación: `docs/plans/2026-08-15-ocr-cms-pwa.md`.
