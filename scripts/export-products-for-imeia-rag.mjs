...
const rows = (data ?? []).map((p) => ({
  ...
  beneficios_es: p.atributos?.beneficios_es || [],
  beneficios_en: p.atributos?.beneficios_en || [],
  valor_es: p.atributos?.valor_es || null,
  valor_en: p.atributos?.valor_en || null,
  preguntas_frecuentes_es: p.atributos?.preguntas_frecuentes_es || [],
  preguntas_frecuentes_en: p.atributos?.preguntas_frecuentes_en || [],
