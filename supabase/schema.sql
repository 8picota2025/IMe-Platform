...
ALTER TABLE solicitudes_cotizacion ADD COLUMN IF NOT EXISTS impuestos_incluidos BOOLEAN;
...
-- Sent quotes are immutable commercial offers (duplicate-on-revise).
