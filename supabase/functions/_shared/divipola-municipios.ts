/**
 * Catálogo oficial DIVIPOLA (DANE) de departamentos y municipios de Colombia.
 * Fuente: datos.gov.co, dataset gdxc-w37w ("DIVIPOLA - Códigos municipios"),
 * descargado el 2026-07-07. 1122 municipios, códigos sin modificar.
 * Formato de cada fila: [cod_dpto, nombre_dpto, cod_mpio, nombre_municipio].
 * cod_dpto/cod_mpio son los state_code/city_code que exige Siigo en address.city.
 */

export const DIVIPOLA_MUNICIPIOS: ReadonlyArray<readonly [string, string, string, string]> = [
