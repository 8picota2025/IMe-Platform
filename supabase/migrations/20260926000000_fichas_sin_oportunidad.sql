-- Las descargas de fichas técnicas (campaign = 'pdf_descarga') tampoco abren oportunidad en el
-- warehouse CRM, como las herramientas (20260925220000). Decisión del usuario, 2026-09-25.
-- Única diferencia con esa migración: la condición del IF.
...
BEGIN
  ...
  -- Lead magnets (herramientas y fichas técnicas): sólo cuenta, contacto y actividad. La oportunidad la crea la
  ...
  IF NEW.campaign NOT IN ('herramienta', 'pdf_descarga') THEN
