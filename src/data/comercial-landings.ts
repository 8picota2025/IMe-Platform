...
const TORRES: ContentMap = {
  es: {
    ...
    heroImageAlt: 'Quirófano preparado para cirugía de mínima invasión — I-ME Colombia',
  ...
  en: {
    ...
    heroImage: '/assets/img/quirofanos-inteligentes.webp',
    heroImageAlt: 'Operating room prepared for minimally invasive surgery — I-ME Colombia',
...
const ESTERILIZACION: ContentMap = {
  es: {
    ...
    heroImageAlt: 'Instalación hospitalaria — apoyo a central de esterilización I-ME',
    ...
    productSlugs: ['autoclave-5075', 't-max-6', 'automate-ref-ahpv1115v-saniswiss'],
  ...
  en: {
    ...
    heroImage: '/assets/img/hospital-facility.webp',
    heroImageAlt: 'Hospital facility — I-ME support for sterilization centrals',
...
const IMAGENOLOGIA: ContentMap = {
  es: {
    ...
    heroImageAlt: 'Sala de radiología diagnóstica — I-ME Colombia',
    ...
    productSlugs: ['alc-280', 'dm156', 'dr-ceiling', 'dus-5000'],
  ...
  en: {
    ...
    heroImage: '/assets/img/sala-radiologia-diagnostica.webp',
    heroImageAlt: 'Diagnostic radiology room — I-ME Colombia',
...
const ROBOTICA: ContentMap = {
  es: {
    ...
    heroImage: '/assets/img/sala-cirugia-robotica.webp',
    heroImageAlt: 'Entorno clínico con tecnología avanzada — I-ME Colombia',
  ...
  en: {
    ...
    heroImage: '/assets/img/sala-cirugia-robotica.webp',
    heroImageAlt: 'Clinical environment with advanced technology — I-ME Colombia',
