...
const ESTERILIZACION: ContentMap = {
  es: {
    ...
    productSlugs: [
      'autoclave-horizontal-5075-tuttnauer',
      't-max-6-tuttnauer',
...
const MONITORES_BIOLIGHT: ContentMap = {
  es: {
    ...
    productSlugs: [
      ...
      'monitor-modular-de-paciente-pm-200m-advanced',
    ],
...
const CAMILLAS_MEDICAS: ContentMap = {
  es: {
    ...
    productSlugs: [
      ...
      'camilla-manual-st-100-advanced',
    ],
